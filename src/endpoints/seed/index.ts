...
import { achievement1 } from './achievement-1';
import { achievement2 } from './achievement-2';
...
export const seed = async ({
  ...
  await payload.create({
    ...
    data: event1({ featuredImage: image1Doc, author: demoAuthor }),
  });
  ...
  await payload.create({
    ...
    data: event2({ featuredImage: image2Doc, author: demoAuthor }),
  });
  ...
  await payload.create({
    ...
    data: news1({ featuredImage: image1Doc, author: demoAuthor }),
  });
  ...
  await payload.create({
    ...
    data: news2({ featuredImage: image2Doc, author: demoAuthor }),
  });

  payload.logger.info(`— Seeding achievements...`);

  // Do not create achievements with `Promise.all` because we want the achievements to be created in order
  await payload.create({
    ...
    data: achievement1({ featuredImage: image1Doc, author: demoAuthor }),
  });
  ...
  await payload.create({
    ...
    data: achievement2({ featuredImage: image2Doc, author: demoAuthor }),
  });
